...
public class BoundingRectangleBoundingRectangleCollisionTestDataGenerator : IEnumerable<object[]>
{
    private readonly List<object[]> _data = new()
    {
        ...
        new object[]
        {
            new BoundingRectangle(Vector2.Zero, Vector2.One), new BoundingRectangle(Vector2.One, new Vector2(2)), true
        },
        new object[]
        {
            new BoundingRectangle(Vector2.Zero, Vector2.One), new BoundingRectangle(new Vector2(2), new Vector2(3)),
            false
        }
    };
