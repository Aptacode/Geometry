...
{
    public static IReadOnlyList<ProfileFunction> GeometryFunctions() => new ProfileFunction[]
    {
        //Ellipse
        ...
        new PrimitiveFunction<Ellipse>((f) => f.CollidesWith(BoundingRectangle.FromTwoPoints(new Vector2(0,0), new Vector2(10,10))), "rectangle collision"),
        ...
        new PrimitiveFunction<Point>((f) => f.CollidesWith(BoundingRectangle.FromTwoPoints(new Vector2(0,0), new Vector2(10,10))), "rectangle collision"),
        ...
        new PrimitiveFunction<PolyLine>((f) => f.CollidesWith(BoundingRectangle.FromTwoPoints(new Vector2(0,0), new Vector2(10,10))), "rectangle collision"),
        ...
        new PrimitiveFunction<Polygon>((f) => f.CollidesWith(BoundingRectangle.FromTwoPoints(new Vector2(0,0), new Vector2(10,10))), "rectangle collision"),
    };
}